...
export function RaceCalculator() {
  ...
  const distances = ['5 km', '10 km', '20 km', 'Half Marathon', 'Marathon', 'Custom'];
  ...
  return (
    <Card shadow="sm" padding="xl" radius="md">
      ...
      <Box mb="xl">
        ...
        <Chip.Group multiple={false} value={selectedChip} onChange={handleChipChange}>
          <Group gap="xs">
        ...
        <TextInput
          ...
          onChange={(event) => {
            ...
            const distance = roundToThreeDecimals(parseFloat(event.currentTarget.value))
